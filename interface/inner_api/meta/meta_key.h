...
public:
    ...
    static constexpr const char MAX_BITRATE[] = "max_bitrate"; ///< int64_t, Key for max bitrate
    static constexpr const char SQR_FACTOR[] = "sqr_factor"; ///< uint32_t, key for the desired encoding quality, 
