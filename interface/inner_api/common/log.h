...
#define LOG_DOMAIN_DEMUXER 0xD002B0C
#undef LOG_DOMAIN_MUXER
#define LOG_DOMAIN_MUXER 0xD002B0D
#undef LOG_DOMAIN_MEDIA_CODEC
...
#define MEDIA_LOG_I_NO_RELEASE(fmt, ...) HST_HILOG_NO_RELEASE(::OHOS::HiviewDFX::HiLog::Info, fmt, ##__VA_ARGS__)
#define MEDIA_LOG_W_NO_RELEASE(fmt, ...) HST_HILOG_NO_RELEASE(::OHOS::HiviewDFX::HiLog::Warn, fmt, ##__VA_ARGS__)
#define MEDIA_LOG_E_NO_RELEASE(fmt, ...) HST_HILOG_NO_RELEASE(::OHOS::HiviewDFX::HiLog::Error, fmt, ##__VA_ARGS__)
#define MEDIA_LOG_F_NO_RELEASE(fmt, ...) HST_HILOG_NO_RELEASE(::OHOS::HiviewDFX::HiLog::Fatal, fmt, ##__VA_ARGS__)
