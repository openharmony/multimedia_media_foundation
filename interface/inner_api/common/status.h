...
enum struct Status : int32_t {
    ...
    ERROR_FILE_NOT_FOUND = 0xF201,
    ERROR_FILE_BAD_HANDLE = 0xF202,
    ERROR_FILE_PERMISSION_DENIED = 0xF203,
    ERROR_FILE_INVALID_DATA = 0xF204,
    ERROR_FILE_ACCESS_FAILED = 0xF205,
    ERROR_FILE_ILLEGAL_OPERATION = 0xF206,
    ERROR_AUDIO_DEC_INIT_FAILED = 0xF207,
    ERROR_AUDIO_DEC_UNAVAILABLE = 0xF208,
    ERROR_AUDIO_DEC_NOT_SUPPORT = 0xF209,
    ERROR_AUDIO_DEC_FAILED = 0xF20A,
    ERROR_AUDIO_DEC_TIMEOUT = 0xF20B,
    ERROR_AUDIO_ENC_INIT_FAILED = 0xF20C,
    ERROR_AUDIO_ENC_UNAVAILABLE = 0xF20D,
    ERROR_AUDIO_ENC_NOT_SUPPORT = 0xF20E,
    ERROR_AUDIO_ENC_FAILED = 0xF20F,
    ERROR_AUDIO_ENC_TIMEOUT = 0xF210,
    ERROR_VIDEO_DEC_INIT_FAILED = 0xF211,
    ERROR_VIDEO_DEC_UNAVAILABLE = 0xF212,
    ERROR_VIDEO_DEC_NOT_SUPPORT = 0xF213,
    ERROR_VIDEO_DEC_FAILED = 0xF214,
    ERROR_VIDEO_DEC_TIMEOUT = 0xF215,
    ERROR_VIDEO_ENC_INIT_FAILED = 0xF216,
    ERROR_VIDEO_ENC_UNAVAILABLE = 0xF217,
    ERROR_VIDEO_ENC_NOT_SUPPORT = 0xF218,
    ERROR_VIDEO_ENC_FAILED = 0xF219
    ERROR_VIDEO_ENC_TIMEOUT = 0xF21A,
};
} // namespace Media
} // namespace OHOS
#endif // STATUS_H
