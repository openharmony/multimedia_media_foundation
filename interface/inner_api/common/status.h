...
enum struct Status : int32_t {
    ...
    ERROR_AVCODEC_TIMEOUT_NO_VIDEO_FRAMES_RECEIVED = 0xF033,
    ERROR_AUDIO_BITRATE_LE_ZERO = 0xF034,
    ERROR_VIDEO_BITRATE_LE_ZERO = 0xF035,
    ERROR_VID_DEC_RESOLUTION_UNSUPPORTED = 0xF036,
    ERROR_VID_ENC_RESOLUTION_UNSUPPORTED = 0xF037,
